...
Route::get('/pzn', function () {
    return "Hello Satrai_bagus";
});

Route::redirect('/youtube', '/pzn');

Route::fallback(function () {
    return "404 by Satrai_bagus";
});

Route::view('/hello', 'hello', ['name' => 'Satria']);
...
Route::get('/hello-world', function () {
    return view('hello.world', ['name' => 'Satria']);
});
...
Route::get('/conflict/satria', function () {
    return "Conflict Satria Bagus Eka candra";
});
